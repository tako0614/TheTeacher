...
vi.mock("./lib/api-client", () => ({
  ...
  fetchBillingPricing: vi.fn(async () => ({
    currency: "jpy",
    unitAmount: 1200,
    creditsPerPack: 120,
    label: "120 credits / JPY 12",
  })),
  fetchBillingBalance: vi.fn(async () => ({ credits: 240 })),
  createBillingCheckout: vi.fn(async () => ({ url: "https://example.com/checkout" })),
